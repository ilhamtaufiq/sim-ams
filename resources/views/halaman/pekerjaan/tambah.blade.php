        ...
        <form action="{{route('pekerjaan.store')}}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="program_id" id="program_id" class="form-control select2" style="width: 100%;">
                    ...
                    @foreach ($keg as $item)
                    <option value="{{$item->id}}">{{$item->program}} - {{$item->sub_kegiatan}}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                <label for="nama_pekerjaan">Nama Pekerjaan</label>
                {{-- <select name="nama_pekerjaan" id="nama_pekerjaan" class="form-control select2" style="width: 100%;">
...
{{-- <script>
  jQuery.ajax({
      ...
      success:function(data) {
          ...
          // console.log(value[3]);
          // $(tes).html(value[2]);
          $($('#nama_pekerjaan')).append('<option value="'+ value[2] +'">'+ value[2] +'</option>');
