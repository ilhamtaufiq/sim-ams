...
@section('js')
<script>
    $('[name=program_id]').val("{{$kontrak->program_id}}");
    $('[name=harga_kontrak]').val("{{$kontrak->harga_kontrak}}");
    $('[name=no_spk]').val("{{$kontrak->no_spk}}");
    $('[name=tgl_spk]').val("{{$kontrak->tgl_spk}}");
    $('[name=tgl_mulai]').val("{{$kontrak->tgl_mulai}}");
    $('[name=tgl_selesai]').val("{{$kontrak->tgl_selesai}}");
    $('[name=nama_pelaksana]').val("{{$kontrak->nama_pelaksana}}");
    $('[name=nama_pengawas]').val("{{$kontrak->nama_pengawas}}");
    var $newOption = $("<option selected='selected'></option>").val("{{$kontrak->pekerjaan->id}}").text("{{$kontrak->pekerjaan->nama_pekerjaan}}")
