              ...
              <div class="card-table table-responsive">
                <table class="table table-vcenter">
                  ...
                  <tr>
                    ...
                    <td class="text-muted">{{$am1->count()}}</td>
                    <td class="text-muted">{{number_format($am1->sum('pagu'))}}</td>
                  ...
                  <tr>
                    ...
                    <td class="text-muted">{{$am2->count()}}</td>
                    <td class="text-muted">{{number_format($am2->sum('pagu'))}}</td>
                    <td class="text-end w-1">
                  ...
                  <tr>
                    ...
                    <td class="text-muted">{{$am3->count()}}</td>
                    <td class="text-muted">{{number_format($am3->sum('pagu'))}}</td>
                    <td class="text-end w-1">
                  ...
                  <tr>
                    ...
                    <td class="text-muted">{{$sandak->count()}}</td>
                    <td class="text-muted">{{number_format($sandak->sum('pagu'))}}</td>
                    <td class="text-end w-1">
                  ...
                  <tr>
                    ...
                    <td class="text-muted">{{$mck->count()}}</td>
                    <td class="text-muted">{{number_format($mck->sum('pagu'))}}</td>
                    <td class="text-end w-1">
              ...
              <div class="row align-items-center">
                <div class="col-10">
                  ...
                  <div class="markdown text-muted">
                    ...
                    download any of the 1719 icons in SVG, PNG or&nbsp;React and use them in your favourite design tools.
                  </div>
                  <div class="mt-3">
