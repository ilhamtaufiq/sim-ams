    ...
    <div class="container-xl">
        <div class="row row-deck row-cards">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <span>Nomor Kontrak: {{ $tfl->pekerjaan->detail->no_spk ?? 'Data Belum Diinput' }}</span> <br>
                        <span>Pelaksana: {{ $tfl->pekerjaan->detail->nama_pelaksana ?? 'Data Belum Diinput' }}</span> <br>
                        <span>Mulai:
                            @if (is_null($tfl->pekerjaan->detail))
                                Data Belum Diinput
                            @else
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">{{$tfl->pekerjaan->desa->n_desa}} - {{$tfl->pekerjaan->kec->n_kec}}</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
