            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <form id="realisasi">
                    ...
                    <div class="modal-content">
                            ...
                            <div class="mb-3">
                                ...
                                <?php $__currentLoopData = $d->pekerjaan->output; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $output): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-floating mb-3">
                                        ...
                                        <input name="output_id[<?php echo e($i++); ?>]" type="number" value="<?php echo e($output->id); ?>" hidden>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn me-auto" data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-primary save-data" data-bs-dismiss="modal">Upload</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $(".save-data").click(function(event){
        ...
        let realisasi = $("input[name=realisasi]").val();
        let _token   = $('meta[name="csrf-token"]').attr('content');
  
        $.ajax({
          url: "/realisasi/output/",
          type:"POST",
          data:{
            name:realisasi,
            _token: _token
