...
<?php $__env->startSection('content'); ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" id="modal-content">
                ...
                <div class="modal-body">
                    <form class="needs-validation" novalidate="" action="<?php echo e(route('aspirasi.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="modal-body">
                            <div class="mb-3">
                                <label>Program</label>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-muted">Hapus Kegiatan Aspirasi <?php echo e($d->pekerjaan->nama_pekerjaan); ?></div>
                </div>
                <div class="modal-footer">
                    <div class="w-100">
                        <div class="row">
                            ...
                            <form action="<?php echo e(route('aspirasi.destroy', $d->id)); ?>" method="post">
    ...
    <div class="modal fade bd-example-modal-lg" id="modal-ubah<?php echo e($d->id); ?>" tabindex="-1" role="dialog"
    aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" id="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="needs-validation" novalidate="" action="<?php echo e(route('aspirasi.update', $d->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).on('click', '.btn-edit', function() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('edit/aspirasi')); ?>",
                data: {
                    id: id
                },
                dataType: 'json',
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/ams/resources/views/pages/pekerjaan/aspirasi.blade.php ENDPATH**/ ?>