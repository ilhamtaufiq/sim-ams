    ...
    <div class="container-xl">
        <div class="row row-deck row-cards">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <span>Nomor Kontrak: <?php echo e($pekerjaan->detail->no_spk ?? 'Data Belum Diinput'); ?></span> <br>
                        <span>Pelaksana: <?php echo e($pekerjaan->detail->nama_pelaksana ?? 'Data Belum Diinput'); ?></span> <br>
                        <span>Mulai:
                            <?php if(is_null($pekerjaan->detail)): ?>
                                Data Belum Diinput
                            <?php else: ?>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title"><?php echo e($pekerjaan->desa->n_desa); ?> - <?php echo e($pekerjaan->kec->n_kec); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
...
<?php echo $__env->make('layouts.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/ams/resources/views/pages/pekerjaan/info.blade.php ENDPATH**/ ?>