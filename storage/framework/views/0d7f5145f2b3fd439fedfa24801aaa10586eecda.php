...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="modal fade bd-example-modal-lg" name="modal-ubah" id="modal-ubah<?php echo e($d->id); ?>" tabindex="-1"
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <select id="program" name="program_id"
                                        ...
                                        style="width: 100%;">
                                        <option selected disabled value=""><?php echo e($d->kegiatan->sub_kegiatan); ?></option>
                                        <optgroup label="Sanitasi">
                                            <option value="1">Pembangunan/Penyediaan Sub Sistem Pengolahan Setempat</option>
                                            <option value="2">Pembangunan/Penyediaan Sistem Pengelolaan Air Limbah Terpusat
                                                Skala Permukiman</option>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Repo\sim-ams\resources\views/pages/kontrak/index.blade.php ENDPATH**/ ?>