...
<?php $__env->startSection('content'); ?>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                            data-bs-target="#modal-team<?php echo e($item->id); ?>">
                                                            Upload Dokumen
                                                        </a>
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal"
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <!-- Upload Dokumen -->
        <div class="modal modal-blur fade" id="modal-team<?php echo e($d->id); ?>" tabindex="-1" role="dialog"
            aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <div class="row mb-3 align-items-end">
                                ...
                                <div class="col">
                                    ...
                                    <input value="<?php echo e($d->id); ?>" type="text" name="pekerjaan_id" id="pekerjaan_id"
                                        hidden>
                                </div>
                            </div>
                            <div>
        ...
        <!-- Upload Foto -->
        <div class="modal modal-blur fade" id="modal-foto<?php echo e($d->id); ?>" tabindex="-1" role="dialog"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
...
<?php echo $__env->make('layouts.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/ams/resources/views/pages/pekerjaan/index.blade.php ENDPATH**/ ?>